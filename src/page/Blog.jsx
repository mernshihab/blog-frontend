...
const Blog = () => {
  ...
  useEffect(() => {
    let config = {
      ...
      url: `https://api.bloogish.mernshihab.xyz/api/v1/frontend/blog/singleblogs/${id}`,
    };
      ...
      <section className="bg-white">
        <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
          ...
          <div className="grid gap-8">
            <article className="p-6 bg-white border border-gray-200 rounded-lg shadow-md">
              ...
              <div className="p-4 my-4 border">
                <img
                  ...
                  src={`https://api.bloogish.mernshihab.xyz/api/v1/images/${blogInfo?.image}`}
                  alt=""
                />
              </div>
                  ...
                  <form>
                    ...
                    <div className="flex items-center">
                      <textarea
                        ...
                        className="block mx-4 p-2.5 w-full sm:w-[350px] text-sm text-gray-900 outline-none bg-white rounded-lg border border-gray-300"
            ...
            <div
              id="comments"
              className="px-6 border border-slate-300 py-7 rounded-xl mt-8 lg:mt-0"
            >
              {allComment.length !== 0 &&
                allComment.map((el, index) => (
                  <article key={index}>
                    ...
                    <p className="mb-2 text-gray-500">{el.description}</p>
                  </article>
                ))}
            </div>
          </div>
          ...
          <div className="md:flex md:justify-between">
            <div className="mb-6 w-1/2 md:mb-0">
              ...
              <p className="mt-2 text-gray-500">
                A vibrant blogging platform for sharing stories, ideas, and
                conversations. Join today to post, like, and comment with ease!
              </p>
            </div>
